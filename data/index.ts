...
export const projects = [
  ...
  {
    id: 3,
    title: "FareWheels API",
    des: "FareWheels is a robust Node.js backend application built using the Express.js framework and MongoDB.",
    img: "/p5.png",
    iconLists: ["/re.svg", "/mongo.svg", "/express.png", "/node.svg"],
    link: "https://github.com/raghu-shiv/farewheels-api",
  },
  {
    id: 4,
